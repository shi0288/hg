...
<div data-role="content">
    ...
    <div class="container-fluid">
        <div class="well pxui-tab pxui-tab-nav pxui-tab-no-top">
            ...
            <a href="shopping.html"><i></i>分类<span></span></a>
            <a href="tuan.html?status=0&sortStr=jump&orderBy=-1"><i></i>抢限量<span></span></a>
            <a href="join.html"><i></i>关于我们<span></span></a>
        </div>
    </div>
...
<#--<td rowspan="2"><a href="tuan.html?status=0&sortStr=jump&orderBy=-1"><i></i>限<br>时<br>促<br>销</a>-->
<#--</td>-->
<#--</tr>-->
<#--<tr>-->
...
<#--</div>-->
    ...
    <div class="container-fluid index">
        <div class="pxui-area">
            <h3><b>Top10</b> 热销推荐<a class="pxui-button"
                                    href="shopping.html"><span>+</span> 全部商品 &gt;&gt;</a>
            </h3>
                ...
                <#list tuijian as tui>
                    <#if (tui_index<10)>
                        <a href="javascript:void(0)">
                            ...
                            <p style='margin-left:15px' class="hengAddBox"
                               onclick="ProMoveBox(this,'${tui._id}@${tui.name}@${tui.price}@${tui.oldPrice}@${tui.fileNames[0]}',true)">
                                加入购物车</p>
                        </a>
                    </#if>
                </#list>
        ...
        <div class="container-fluid">
            <div class="pxui-area styles">
                <h2 style="background-color: ${(e.colorTip)!""} ; "><a
                        href="shopping.html?status=0&mainProId=${e._id}&sortStr=jump&orderBy=-1"
                        style="color:#FFFFFF;">${(e.name)!""}</a>
                </h2>
                <a class="max" href="shopping.html?status=0&mainProId=${e._id}&sortStr=jump&orderBy=-1"><img
                ...
                <div>
                    <p>
                        <#list e.sortList as s>
                            <#if s.tip==0>
                                <a href="shopping.html?status=0&sortProId=${s._id}&sortStr=jump&orderBy=-1"
                                   style="background-color: ${(e.colorTip)!""} ; color:#FFFFFF;border: 1px solid ${(e.colorTip)!""}; ">${s.name}</a>
                            <#else>
                                <a href="shopping.html?status=0&sortProId=${s._id}&sortStr=jump&orderBy=-1">${s.name}</a>
                            </#if>
                        </#list>
                        <a href="shopping.html?status=0&mainProId=${e._id}&sortStr=jump&orderBy=-1" class="more">更多
