        ...
        <div class="main">
            ...
            <div class="item item-captcha">
                <div class="input-info" style="display:;">
                    <input data-role="none" class="txt-input txt-captcha" id="r_captcha" type="text" size="11"
                           maxlength="6"
                           autocomplete="off" placeholder="    请输入验证码">
                        <span id="captcha-img" onclick="changeImg(this)"><img src="manage/code.img" width="65"
                                                                              height="30"
                                                                              alt=""></span>
                </div>
            </div>
            <div class="item item-phone">
                <input data-role="none" id="r_mobile" class="txt-input txt-phone" type="tel" placeholder="    请输入手机号"
                       maxlength="11" onkeyup="testMobile()"/>
            ...
            <div class="item item-password">
                ...
                <div class="login-free login-free-selected"> 注册即视为同意<a id="" href="xieyi.html" style="color: red">《邻家优购注册协议》</a></a>
                </div>
            </div>
