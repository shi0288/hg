...
//
//        String webTokenUrl = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=" + WeiXinConstant.APPID + "&secret=" + WeiXinConstant.APPSECRET + "&code=" + "031337aa97f44df3a043704370ea3e8A" + "&grant_type=authorization_code";
